import { g as m, r as v, u as b, p as O } from './index-D_KYOTIv.js';
function V(t, e) {
...
var D = Object.create,
    ...
    o = (t, e, r) => (A(t, typeof e != 'symbol' ? e + '' : e, r), r),
    _ = {};
E(_, { default: () => y });
var f = R(_),
    c = L(v),
...
class y extends c.Component {
    constructor() {
        super(...arguments),
            o(this, 'callPlayer', d.callPlayer),
            o(this, 'mute', () => {
                this.setVolume(0);
            }),
            o(this, 'unmute', () => {
    ...
    load(e) {
        const { playing: r, config: s, onError: a, onDuration: n } = this.props,
            l = e && e.match(P.MATCH_URL_VIDYARD)[1];
        this.player && this.stop(),
            (0, d.getSDK)(x, C, N).then((p) => {
                this.container &&
                    (p.api.addReadyListener((u, g) => {
                        this.player ||
                            ((this.player = g),
                    ...
                    p.api.getPlayerMetadata(l).then((u) => {
                        (this.duration = u.length_in_seconds),
