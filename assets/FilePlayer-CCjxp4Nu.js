import { g as b, r as _, u as O, p as A } from './index-D_KYOTIv.js';
function R(s, e) {
...
var I = Object.create,
    ...
    j = (s, e, t) => (
        ...
        E(
            e || !s || !s.__esModule
                ? u(t, 'default', { value: s, enumerable: !0 })
                : t,
            s,
        )
    ),
...
class P extends c.Component {
    constructor() {
        super(...arguments),
            ...
            r(this, 'renderSourceElement', (e, t) =>
                typeof e == 'string'
                    ? c.default.createElement('source', { key: t, src: e })
                    : c.default.createElement('source', { key: t, ...e }),
            ),
            r(this, 'renderTrack', (e, t) =>
                c.default.createElement('track', { key: t, ...e }),
            ),
            r(this, 'ref', (e) => {
    ...
    shouldUseAudio(e) {
        return e.config.forceVideo || e.config.attributes.poster
            ? !1
            : d.AUDIO_EXTENSIONS.test(e.url) || e.config.forceAudio;
    }
    shouldUseHLS(e) {
        return (V && this.props.config.forceSafariHLS) ||
            this.props.config.forceHLS
            ? !0
            : v || this.props.config.forceDisableHls
              ? !1
              : d.HLS_EXTENSIONS.test(e) || f.test(e);
    }
    shouldUseDASH(e) {
...
r(P, 'canPlay', d.canPlay.file);
const z = b(g),
    J = R({ __proto__: null, default: z }, [g]);
export { J as F };
